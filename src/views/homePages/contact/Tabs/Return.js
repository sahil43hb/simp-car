    ...
    return (
        ...
        <Container>
                ...
                <Grid sx={{ paddingBottom: '30px' }}>
                    ...
                    Abo kündigen und Fahrzeug zurückgeben
                    </Typography>
                    <Typography
                        fontSize="16px"
                        sx={{ padding: { xs: '10px 0px', sm: '25px 85px', md: '25px 185px' }, textAlign: { xs: 'left', sm: 'center' } }}
                    >
                    Wenn Sie sich entschieden haben, Ihr Abonnement bei uns zu kündigen, nehmen wir dies ernst und danken Ihnen dafür
                    bisherige Zusammenarbeit. Sie können den Widerruf mit den untenstehenden Informationen veranlassen. Wir werden uns umgehend bei Ihnen melden.
                    </Typography>
                </Grid>
            </Container>
