...
const Recall = () => {
    ...
    return (
            ...
            <Container>   <Grid sx={{paddingBottom:"30px"}}>
                    ...
                    <Typography fontSize="16px" sx={{ padding: { xs: '10px 0px', sm: '25px 85px',md:"25px 185px" },textAlign: { xs: 'left', sm: 'center' } }}>
                    Hinterlassen Sie hier Ihre Kontaktdaten und wir rufen Sie gerne an, um Ihre Fragen zu beantworten und Sie zum Auto-Abo zu beraten.
                    </Typography>
                </Grid></Container>
                ...
                <Grid sx={{ background: '#92bd44',padding: {xs:'5px 5px',sm:"34px 75px"}, borderRadius: '15px' }}>
                    ...
                    <Grid container spacing={4}>
                        ...
                        <Grid item xs={12} sm={6}>
                            <TextField fullWidth label="Verfügbar von/bis"  />
                        </Grid>
...
<Button type='submit' style={{color:"#FFFF",fontSize: '17px',fontWeight: 500,background: "#92bd44",padding: '12px 25px',borderRadius:"30px"}}>
Formular absenden
<IoIosArrowForward/>
</Button>
</Grid>
