...
const [secondvalue, setsecondvalue] = useState()
    ...
    <Grid
                ...
                alignItems="center"
                sx={{ mt: { xs: 10, sm: 6, md: -26 }, mb: { xs: 2.5, md: 10 } }}
            >
                <Grid item xs={12} md={12}>
                    <Grid  >
                        <Grid container spacing={2}>
                            <Grid item lg={5.5} md={5.5} sm={12} xs={12} >
                                <Typography variant="body2" sx={{ fontSize: '24px',fontWeight: 500, color: '#92BD44' ,paddingTop:{xs:'0px',md:"64px"}}}>
                                Fahrzeugdaten für die{company} {model}
                                </Typography>

                                <Typography variant="body2" style={{ fontSize: '16px', marginTop: '30px' }}>
                                    {description}
                                </Typography>

                                <Typography variant="body2" style={{ fontSize: '22px', marginTop: '20px' }}>
...
Technische Details
                                ...
                                <Grid container spacing={2} style={{marginTop:'20px'}}>
                                    ...
                                    <Grid style={{ display: 'flex' }}>
                                        <Grid style={{ border: '2px solid #F2F1F0', borderRadius: '6px', padding: '0px 11px' }}>
                                           <img alt='not' src={Speed} style={{width:"40px"}}/>
                                        </Grid>
                                        <Grid style={{ padding: '7px 15px' }}>
                                            <Typography variant="body2" style={{ fontSize: '12px', marginTop: '5px' }}>
                                    ...
                                    <Grid item lg={6} md={6} sm={6} xs={6}>
                                        <Grid style={{ display: 'flex' }}>
                                            <Grid style={{ border: '2px solid #F2F1F0', borderRadius: '6px', padding: '9px 4px' }}>
                                                ...
                                                <svg id="fuel-station" xmlns="http://www.w3.org/2000/svg" width="50" height="30" viewBox="0 0 77.198 84.879">
...
Anzahl Sitzplätze
                                ...
                                <Grid sx={{paddingTop:"70px",paddingBottom:"20px"}}><Typography fontSize="18px" >
                                Umfeld</Typography></Grid> 
                                <Grid item xs={12} sx={{padding:"20px 20px",background:"#f5f5f5",borderRadius:"10px"}}>
                                 <Grid container spacing={2} >
                                <Grid item xs={6} sm={4} borderRight="1px solid #cecece" >
                                 <Typography>Ø Verbrauch</Typography>
                                 <Typography variant='h4' pt={1}>7.0L</Typography>
                                </Grid>
                                <Grid item xs={6} sm={4} sx={{borderRight:{xs:"",sm:"1px solid #cecece"}}}>
                                <Typography>CO 2 Emission</Typography>
                                <Typography variant='h4' pt={1}>159g/km</Typography>
                                </Grid>
                                <Grid item xs={6} sm={4} >
                                <Typography >
                                Energieeffizienz</Typography>
                                <Typography variant='h4' pt={1}>D</Typography>
                                </Grid>
                                ...
                                <Grid style={{marginTop:'25px'}}>
                                    <Typography variant='body2' style={{fontSize:'20px'}}>Möblierung</Typography>
                                </Grid>
                            ...
                            <Grid item lg={6.5} md={6.5} sm={12} xs={12}>
                                <Grid
                                    sx={{
                                        ...
                                        borderRadius: '30px',
                                        width: '100%',
                                        padding:{xs: '20px',sm:"60px 40px"},
                                       
                                    }}
                                >
                                    <Typography variant="body2" style={{ fontSize: '27px' }}>
                                        <span style={{ color: '#92BD44' }}>
                                        Konfigurieren</span> Abonnements und{' '}
                                        <span style={{ color: '#92BD44' }}>Berechnung</span> Mieten
                                    </Typography>

                                    <Grid>
                                        <Typography variant="body2" style={{ marginTop: '25px', fontSize: '20px' }}>
                                        Monatliches Meilenpaket
                                        </Typography>
                                    ...
                                    <Grid container spacing={2}>
                                        <Grid item xs={8}>
                                            <Typography variant="h3" style={{ fontSize: '24px',marginTop: '25px',  }}>
                                            Ihre monatliche Rate <span style={{ fontSize: '12px' }}>in CHF</span>
                                            </Typography>
                                        </Grid>
                                        <Grid item xs={4}>
                                            <Typography variant="h3" style={{ fontSize: '24px', textAlign: 'right',marginTop: '25px' }}>
                                            {firstvalue + secondvalue}
                                            </Typography>
                                        </Grid>
                                    </Grid>

                                    <Grid style={{ display: 'flex', marginTop: '17px' }}>
                                        <CheckCircleIcon style={{ color: '#92BD44' }} />
                                        <Typography variant="h5" style={{ marginTop: '4px', paddingLeft: '10px', }}>
                                       
Alle Abo-Dienste inklusive
                                        </Typography>
                                    </Grid>

                                    <Grid style={{ display: 'flex', marginTop: '10px' }}>
                                        <CheckCircleIcon style={{ color: '#92BD44' }} />
                                        <Typography variant="h5" style={{ marginTop: '2px', paddingLeft: '10px' }}>
                                    ...
                                    <Grid container spacing={2} style={{ marginTop: '20px' }}>
                                        <Grid item lg={6} md={6} sm={12} xs={12}>
                                            <ThemeButton title="
                                            Online-Buchung" OnClick={() => navigate(`/check-out-step1/${id}`)} />
                                        </Grid>
                                        <Grid item lg={6} md={6} sm={12} xs={12}>
                                            <ModalDetail />
                                        </Grid>
                                ...
                                <Grid container spacing={2} style={{ marginTop: '20px' }}>
                                    ...
                                    <Grid item lg={9} md={9} sm={8} xs={8}>
                                        ...
                                        Tust du<span style={{ color: '#92BD44' }}>habe Fragen</span>und brauchen{' '}
                                            <span style={{ color: '#92BD44' }}>advice</span>?
                                        </Typography>
                                        <Typography variant="body2" style={{ fontSize: '16px' }}>
                                        Unser Kundenservice freut sich auf Ihre Kontaktaufnahme. → Zur Kontaktseite
                                        </Typography>
                                    </Grid>
                                </Grid>
                            </Grid>
