    ...
    return (
        ...
        <SubCard
            sx={{
                ...
                marginLeft: {xs:'-44px',sm:'0px',md:'0px',lg:'0px', xl:'0px'},
        ...
        <Grid
             ...
             >
                 {carData.map((data, index) => (
                     <Grid item lg={4} md={5} sm={5} xs={12} key={index}  sx={{ marginRight:{xs:'-80px',sm:"50px",md:"75px",lg:"0px"}}}>
                         <OfferCard
                             textDetail={`${data.car_company.name}-${data.name}`}
                             icon={correctImg}
                 ...
                 <Grid item lg={4} md={6} sm={6} sx={{marginBottom:"20px"}}>
                 <ProductCradDetail />
                 </Grid>
                 <Grid item lg={4} md={6} sm={6} sx={{marginBottom:"20px"}}>
                     <EmptyProductCard />
