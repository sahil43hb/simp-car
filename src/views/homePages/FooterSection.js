...
const FooterSection = () => {
    ...
    return (
        <>
            <Container maxWidth={false} style={{ background: '#3e4143', padding: '15px 0px 30px 20px', marginTop: '-148px ' }}>
                <Container>
                    <Grid container spacing={2}>
                        ...
                        <Grid item xs={12} md={3} lg={2}>
                            <ThemeButton title="Kontaktiere uns!" OnClick={()=>navigate("/contact")} style={{ width: '50%', float: 'right' }} />
                        </Grid>
                    </Grid>
                </Container>
            </Container>
                        ...
                        <Grid container spacing={8} style={{ marginTop: '15px' }}>
                            <Grid item xs={12} md={4}>
                                <Stack spacing={{ xs: 2, md: 5 }}>
                                    ...
                                    Das<b> Auto-Abo</b> von <b>simpcar</b>  ist eine flexible Alternative zum Kauf oder Leasing eines Fahrzeugs. Es bietet die Möglichkeit, ein Fahrzeug für einen festgelegten Zeitraum zu nutzen, ohne sich um die Kosten und die Wartung kümmern zu müssen.
                                    </Typography>
                                </Stack>

                                <Grid container spacing={2} style={{ marginTop: '20px' }}>
                                    <Grid item xs={3} sm={2} sx={{textAlign:{xs:"center",}}}>
                                    ...
                                    <Grid item xs={12} sm={6} lg={4} sx={{textAlign:"center"}}>
                                        <Grid container spacing={2}>
                                            ...
                                            <Grid item xs={6}>
                                                ...
                                                <StarIcon style={{ fontSize: '18px', color: '#FBBD05' }} />
                                                <StarIcon style={{ fontSize: '18px', color: '#FBBD05' }} />
                                                <p style={{ margin: '0', fontSize: '12px' }}>Aus 53 Rezensionen </p>
                                            </Grid>
                                            <Grid item xs={4} style={{ paddig: '0 !important' }}>
                                                <p style={{ margin: '0', fontSize: '10px', color: '#92BD44' }}>5 von 5 Sternen </p>
                                            </Grid>
                                        </Grid>
                                    </Grid>
                                </Grid>
                ...
                <Container>
                    ...
                    >
                        <Typography style={{ color: '#fff' }}>
                            <Link href="https://phpstack-811730-3654672.cloudwaysapps.com/" target="_blank" underline="hover" style={{ color: '#fff' }}>
