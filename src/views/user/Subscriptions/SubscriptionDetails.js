...
export default function SubscriptionDetails() {
    ...
    return (
       ...
       <Grid container sx={{padding:"10px"}}>
            <Grid container spacing={3} style={{  background: '#FAFAFA', borderRadius: '30px',marginLeft:"0px" }}>
                <Grid item xs={6} sm={6} md={1} lg={1} style={{ padding: '12px 33px' }}>
                    <img src={car} alt="not" style={{ width: '50px' }} />
                </Grid>
                <Grid item xs={6} sm={6} md={2} lg={2}>
                    <Typography>Mazda 2 Automat – Benzin</Typography>
                </Grid>
                <Grid item xs={6} sm={6} md={2} lg={2}>
                    <Typography>Handling over: 15.06.2022 Return: 17.12.2022</Typography>
                </Grid>
                <Grid item xs={6} sm={6} md={2} lg={2}>
