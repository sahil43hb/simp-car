        ...
        >
            {openChatDrawer && (
                ...
                >
                    ...
                    >
                        <Typography pl="8px" variant="h5">
                            Sales Team
                        </Typography>
                        <Box sx={{ p: 3, pt: 0 }}>
                            {loading === true ?    <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', height: '5vh' }}><CircularProgress /></div> : <UserList setUser={sale} />}
                        </Box>
                        ...
                        <Box sx={{ p: 3, pt: 0 }}>
                        {loading === true ? <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', height: '5vh' }}><CircularProgress /></div> : <UserList setUser={finance} />}
                        </Box>
                        ...
                        <Box sx={{ p: 3, pt: 0 }}>
                        {loading === true ? <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', height: '5vh' }}><CircularProgress /></div> : <UserList setUser={delivery} />}
                        </Box>
                    </PerfectScrollbar>
                </MainCard>
            )}
