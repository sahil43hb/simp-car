...
const NotificationSection = () => {
    ...
    try {
        const response = await myAxios.get(`/notification`, { token });
    ...
    const handleMark = async () => {
        const token = window.localStorage.getItem('adminServiceToken');
        try {
            const response = await myAxios.post(`/mark-notification`, { token });
            // console.log(response.data.invoice);
        ...
        <>
            ...
            >
                <Avatar
                    ...
                    color="inherit"
                >
                    <IconBell stroke={1.5} size="20px" onClick={handleOpen} />
                </Avatar>
            </Box>
                                ...
                                {open && (
                                    <MainCard border={false} elevation={16} content={false} boxShadow shadow={theme.shadows[16]}>
                                        ...
                                        <CardActions sx={{ p: 1.25, justifyContent: 'center' }}>
                                            <Button size="small" onClick={handleMark} disableElevation>
                                                Mark all as read
                                            </Button>
                                        </CardActions>
                                    </MainCard>
